...
try:
    ...
    print(f"Server đang chờ kết nối trên {server_address[0]}:{server_address[1]}...")
except Exception as e:
    print(f"Lỗi khi khởi tạo server: {e}")
    print("Thử chạy với quyền Administrator hoặc thay đổi cổng khác")
    exit(1)
