class PlayfairCipher:
    ...
    def create_playfair_matrix(self, key):
        ...
        matrix = list(key)  # Sửa từ list[key] thành list(key)
    ...
    def playfair_decrypt(self, cipher_text, matrix):  # Sửa từ ciphertext thành cipher_text
        ...
        #loại bỏ ký tự 'X' ở cuối nếu nó không phải là ký tự cuối cùng
